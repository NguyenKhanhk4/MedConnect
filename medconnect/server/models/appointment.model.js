...
const AppointmentSchema = new Schema(
  {
    ...
    rescheduledAt: Date,
    // Original appointment info (for in-place rescheduling - when appointment is updated instead of creating new one)
    originalScheduledStart: Date,
    originalScheduledEnd: Date,
    originalSlotId: { type: Schema.Types.ObjectId, ref: "DoctorTimeSlot" },
    originalDoctorId: { type: Schema.Types.ObjectId, ref: "Doctor" },
    originalClinicId: { type: Schema.Types.ObjectId, ref: "Clinic" },
