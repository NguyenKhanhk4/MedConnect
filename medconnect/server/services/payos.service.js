  ...
  try {
    ...
    if (isPaid) {
      ...
      if (isServicePayment) {
        ...
        // Khai báo isPrePaymentFlow ở phạm vi rộng hơn để có thể sử dụng sau này
...
async function sendPaymentConfirmationEmail(
  ...
  try {
    ...
    // Lấy patient từ appointment để đảm bảo đúng patient của appointment
    let actualPatient = patient;
    if (appointment && appointment.patientId) {
      const Patient = (await import("../models/patient.model.js")).default;
      const appointmentPatientId = appointment.patientId._id || appointment.patientId;
